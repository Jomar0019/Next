    ...
    <div className="w-[30%] ">
        <div className="flex justify-between ">
            <div className="bg-[#2d2b42]/40 w-[90%] h-[400px] relative">
                <Image src="https://images.pexels.com/photos/20750259/pexels-photo-20750259/free-photo-of-pigeon-point-lighthouse.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" fill priority sizes="100%" alt="ii" className="object-contain" />
            </div>
